      ...
      <div className="flex items-center gap-4">
        ...
        {(activeTab === 'overview' || activeTab === 'classes') && (
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm shadow-blue-600/25 transition-all hover:bg-blue-700 hover:shadow-md hover:shadow-blue-600/30 active:scale-[0.98]"
          >
